      ...
      <div className="flex flex-col min-h-screen">
        <div className="container flex flex-col flex-1 px-6 py-12 mx-auto">
          <div className="flex-1 lg:flex lg:items-center lg:-mx-6">
            <div className="text-gray-900 lg:w-1/2 lg:mx-6">
              <h1 className="text-2xl font-semibold capitalize lg:text-3xl">
                Ultimate solution
              </h1>

              <p className="max-w-xl mt-6">
                Welcome to our online pharmacy! We offer a wide range of
                products, including prescription medications, over-the-counter
                drugs, and health supplements. Enjoy a seamless shopping
                experience with fast, reliable delivery. For any questions or
                assistance, please contact us using the form available on our
              ...
              <div className="mt-6 md:mt-8">
                ...
                <div className="flex mt-4 -mx-1.5 ">
                  <a
                    className="mx-1.5 text-gray-900 transition-colors duration-300 transform hover:text-blue-500"
                    href="#"
                  >
                    <svg
